...
function PersonMonthDetailByPersonKeyAndMonth() {
    const {personKey, month} = useParams();

    const {loading, error, data} = useQuery(fetchPersonMonthByPersonKeyAndMonth, {
        variables: {personKey: personKey, month: month}
    });
    ...
    const personMonth = data.personMonthByPersonKeyAndMonth
    ...
    return (
        <Box>
            <Typography variant="body" noWrap>
                ...
                FTE: {timeSpentMonthFte.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}
                <br/>
                - аналитика: {analysisTimeSpentMonthFte.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })} <br/>
                - разработка: {developmentTimeSpentMonthFte.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })} <br/>
                - тестирование: {testingTimeSpentMonthFte.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })} <br/>
                - управление: {managementTimeSpentMonthFte.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })} <br/>
                - инциденты: {incidentFixingTimeSpentMonthFte.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })} <br/>
                - непроизводственная деятельность: {nonProjectActivityTimeSpentMonthFte.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })} <br/>
            </Typography>
...
export default PersonMonthDetailByPersonKeyAndMonth;