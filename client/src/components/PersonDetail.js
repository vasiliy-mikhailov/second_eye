...
function PersonDetail() {
    const {key} = useParams();
    const {loading, error, data} = useQuery(fetchPersonByKey, {
        variables: {key: key}
    });
    ...
    return (
        <Box>
            <Typography variant="body" noWrap>
                ...
                FTE: {timeSpentChrononFte.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })} <br/>
                - аналитика: {analysisTimeSpentChrononFte.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })} <br/>
                - разработка: {developmentTimeSpentChrononFte.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })} <br/>
                - тестирование: {testingTimeSpentChrononFte.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })} <br/>
                - управление: {managementTimeSpentChrononFte.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })} <br/>
                - инциденты: {incidentFixingTimeSpentChrononFte.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })} <br/>
                - непроизводственная деятельность: {nonProjectActivityTimeSpentChrononFte.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })} <br/>
            </Typography>
