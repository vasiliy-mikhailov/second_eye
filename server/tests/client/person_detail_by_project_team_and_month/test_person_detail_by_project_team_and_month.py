...
def test_person_detail_by_project_team_and_month():
    ...
    executed = graphene_client.execute(
        ...
        """,
        variables={"personKey": person_key, "month": two_weeks_ago_first_day_of_month},
    )
    assert executed == {
        "data": {
            "personMonthByPersonKeyAndMonth": {
                ...
                "nonProjectActivityTimeSpentMonthFte": pytest.approx(6.0 / number_of_working_days_occured / 8.0),
                "timeSpentMonthFte": pytest.approx(21.5 / number_of_working_days_occured / 8.0),
                "incidents": [
                    {
                        "incident": {
                            "id": incident_id,
                        ...
                        "timeSpentMonthFte": pytest.approx(1.5 / number_of_working_days_occured / 8.0),
                    },
                ],
                "systemChangeRequests": [
                    {
                ...
                "nonProjectActivities": [
                    {
                        ...
                        "timeSpentMonthFte": pytest.approx(6.0 / number_of_working_days_occured / 8.0),
                    },
                ],
                "tasks": [
                    {
                        ...
                        "timeSpentMonthFte": pytest.approx(2.0 / number_of_working_days_occured / 8.0),
                    },
                    {
                        "task": {
                        ...
                        "timeSpentMonthFte": pytest.approx(3.0 / number_of_working_days_occured / 8.0),
                    },
                    {
                        "task": {
                            "id": testing_task_id,
                        ...
                        "timeSpentMonthFte": pytest.approx(4.0 / number_of_working_days_occured / 8.0),
                    },
                ],
            }
        }
