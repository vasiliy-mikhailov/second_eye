...
def test_person_detail_by_project_team_id_and_month():
    ...
    executed = graphene_client.execute(
        ...
        """,
        variables={"personKey": person_key, "month": two_weeks_ago_first_day_of_month_string},
    )
    assert executed == {
        "data": {
            "personMonthByPersonKeyAndMonth": {
                "person": {
                    "id": person_id,
                    "name": "Исполнитель",
                },
                "analysisTimeSpentMonthFte": pytest.approx(2.0 / working_days_in_month_occured / 8.0),
                "developmentTimeSpentMonthFte": pytest.approx(3.0 / working_days_in_month_occured / 8.0),
                "testingTimeSpentMonthFte": pytest.approx(4.0 / working_days_in_month_occured / 8.0),
                "managementTimeSpentMonthFte": pytest.approx(5.0 / working_days_in_month_occured / 8.0),
                "incidentFixingTimeSpentMonthFte": pytest.approx(1.5 / working_days_in_month_occured / 8.0),
                "nonProjectActivityTimeSpentMonthFte": pytest.approx(6.0 / working_days_in_month_occured / 8.0),
                "timeSpentMonthFte": pytest.approx(21.5 / working_days_in_month_occured / 8.0),
                "incidents": [
                    {
                        "id": AnyValue(),
                        "incident": {
                        ...
                        "timeSpentMonthFte": pytest.approx(1.5 / working_days_in_month_occured / 8.0),
                    },
                ],
                "systemChangeRequests": [
                    {
                ...
                "nonProjectActivities": [
                    {
                        ...
                        "timeSpentMonthFte": pytest.approx(6.0 / working_days_in_month_occured / 8.0),
                    },
                ],
                "tasks": [
                    {
                        ...
                        "timeSpentMonthFte": pytest.approx(2.0 / working_days_in_month_occured / 8.0),
                    },
                    {
                        "id": AnyValue(),
                        "task": {
                        ...
                        "timeSpentMonthFte": pytest.approx(3.0 / working_days_in_month_occured / 8.0),
                    },
                    {
                        "id": AnyValue(),
                        "task": {
                        ...
                        "timeSpentMonthFte": pytest.approx(4.0 / working_days_in_month_occured / 8.0),
                    },
                ],
            }
        }
