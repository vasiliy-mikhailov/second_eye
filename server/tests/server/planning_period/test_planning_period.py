...
def test_planning_periods_loaded():
...
def test_when_planning_period_has_change_request_and_incident_both_are_summed_up():
    creator = test_data_creator.TestDataCreator()
    ...
    executed = graphene_client.execute(
        """
            query PlanningPeriodById($id: Int) {
