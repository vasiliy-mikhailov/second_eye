...
def test_when_project_team_planning_period_has_change_request_and_incident_both_are_summed_up():
    ...
    executed = graphene_client.execute(
        """
            query ProjectTeamPlanningPeriodByPlanningPeriodIdAndProjectTeamId($planningPeriodId: Int, $projectTeamId: Int) {
                projectTeamPlanningPeriodByPlanningPeriodIdAndProjectTeamId(planningPeriodId: $planningPeriodId, projectTeamId: $projectTeamId) {
                    planningPeriod {
                        id
                    }
        ...
        """,
        variables={"planningPeriodId": current_year, "projectTeamId": project_team_id},
    )
    assert executed == {
        "data": {
