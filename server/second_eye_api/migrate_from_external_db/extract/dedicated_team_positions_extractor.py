        ...
        with get_connection() as connection:
            query = """
                ...
                from 
                    ...
                    inner join jira60.jiraissue team on team.id = team_link.destination and team.issuetype = 13202 -- Выделенная команда
            ...
            dedicated_team_positions = dedicated_team_positions.drop_duplicates(subset=['id'])
