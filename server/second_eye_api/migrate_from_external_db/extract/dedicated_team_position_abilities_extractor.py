        ...
        with get_connection() as connection:
            query = """
                select distinct
                    ...
                    position.id as "dedicated_team_position_id",
            ...
            dedicated_team_position_abilities = dedicated_team_position_abilities.drop_duplicates(subset=['id']).set_index("id")

            self.data = dedicated_team_position_abilities