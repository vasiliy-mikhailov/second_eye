...
class DedicatedTeamPlanningPeriodSystemTimeSheetByDate(cubista.AggregatedTable):
    class Aggregation:
        source = lambda: time_sheet.ProjectTeamPlanningPeriodSystemTimeSheetByDate
        sort_by: [str] = ["date"]
...
class DedicatedTeamPlanningPeriodSystemTimeSheetByDateModel(time_sheet_by_date_model.ModelTable):
    class Model:
        source = lambda: DedicatedTeamPlanningPeriodSystemTimeSheetByDate
        entity_id_field_name = "dedicated_team_planning_period_system_id"

    class Fields:
        dedicated_team_planning_period_system_id = time_sheet_by_date_model.EntityIdField(source="dedicated_team_planning_period_system_id")
