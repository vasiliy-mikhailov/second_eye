...
class CompanyTimeSheetByDate(cubista.AggregatedTable):
    class Aggregation:
        source = lambda: time_sheet.WorkItemTimeSheet
        sort_by: [str] = ["date"]
        group_by: [str] = ["company_id", "date"]
        filter = None
        filter_fields: [str] = []
    ...
    class Fields:
        ...
        time_spent_cumsum = cubista.CumSumField(source_field="time_spent", group_by=["company_id"], sort_by=["date"])
        ...
        time_spent_with_value_cumsum = cubista.CumSumField(source_field="time_spent_with_value", group_by=["company_id"], sort_by=["date"])
        time_spent_without_value_cumsum = cubista.CumSumField(source_field="time_spent_without_value", group_by=["company_id"], sort_by=["date"])
        ...
        time_spent_for_reengineering_cumsum = cubista.CumSumField(source_field="time_spent_for_reengineering", group_by=["company_id"], sort_by=["date"])
        time_spent_not_for_reengineering_cumsum = cubista.CumSumField(source_field="time_spent_not_for_reengineering", group_by=["company_id"], sort_by=["date"])
        ...
        time_sheets_by_date_model_m = cubista.PullByRelatedField(
            foreign_table=lambda: CompanyTimeSheetByDateModel,
            related_field_names=["company_id"],
...
class CompanyTimeSheetByDateModel(time_sheet_by_date_model.ModelTable):
    class Model:
        source = lambda: CompanyTimeSheetByDate
        entity_id_field_name = "company_id"

    class Fields:
        company_id = time_sheet_by_date_model.EntityIdField(source="company_id")
