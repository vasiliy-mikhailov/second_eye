...
class ProjectTeamPlanningPeriodTimeSheetByDate(cubista.AggregatedTable):
    class Aggregation:
        ...
        group_by: [str] = [
            ...
            "project_team_id", "dedicated_team_id", "company_id", "planning_period_id",
            "ordinal_date"
        ]
        filter = None
        filter_fields: [str] = []
    ...
    class Fields:
        ...
        time_spent_for_reengineering_cumsum = cubista.CumSumField(source_field="time_spent_for_reengineering", group_by=["project_team_planning_period_id"], sort_by=["date"])
        time_spent_not_for_reengineering_cumsum = cubista.CumSumField(source_field="time_spent_not_for_reengineering", group_by=["project_team_planning_period_id"], sort_by=["date"])
...
class ProjectTeamPlanningPeriodTimeSheetByDateModel(time_sheet_by_date_model.ModelTable):
    class Model:
        source = lambda: ProjectTeamPlanningPeriodTimeSheetByDate
        entity_id_field_name = "project_team_planning_period_id"

    class Fields:
        project_team_planning_period_id = time_sheet_by_date_model.EntityIdField(source="project_team_planning_period_id")
