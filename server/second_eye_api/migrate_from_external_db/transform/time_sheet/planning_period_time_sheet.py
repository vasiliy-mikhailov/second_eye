...
class PlanningPeriodTimeSheetByDate(cubista.AggregatedTable):
    ...
    class Fields:
        ...
        time_spent_with_value_cumsum = cubista.CumSumField(source_field="time_spent_with_value", group_by=["planning_period_id"], sort_by=["date"])
        time_spent_without_value_cumsum = cubista.CumSumField(source_field="time_spent_without_value", group_by=["planning_period_id"], sort_by=["date"])
        ...
        time_spent_for_reengineering_cumsum = cubista.CumSumField(source_field="time_spent_for_reengineering", group_by=["planning_period_id"], sort_by=["date"])
        time_spent_not_for_reengineering_cumsum = cubista.CumSumField(source_field="time_spent_not_for_reengineering", group_by=["planning_period_id"], sort_by=["date"])
...
class PlanningPeriodTimeSheetByDateModel(time_sheet_by_date_model.ModelTable):
    class Model:
