...
class QuarterTimeSheetByDate(cubista.AggregatedTable):
    class Aggregation:
        source = lambda: time_sheet.DedicatedTeamQuarterTimeSheetByDate
        sort_by: [str] = ["date"]
        group_by: [str] = ["quarter_id", "date"]
        filter = None
        filter_fields: [str] = []
    ...
    class Fields:
        ...
        time_spent_cumsum = cubista.CumSumField(source_field="time_spent", group_by=["quarter_id"], sort_by=["date"])
        ...
        time_spent_with_value_cumsum = cubista.CumSumField(source_field="time_spent_with_value", group_by=["quarter_id"], sort_by=["date"])
        time_spent_without_value_cumsum = cubista.CumSumField(source_field="time_spent_without_value", group_by=["quarter_id"], sort_by=["date"])
        ...
        time_spent_for_reengineering_cumsum = cubista.CumSumField(source_field="time_spent_for_reengineering", group_by=["quarter_id"], sort_by=["date"])
        time_spent_not_for_reengineering_cumsum = cubista.CumSumField(source_field="time_spent_not_for_reengineering", group_by=["quarter_id"], sort_by=["date"])
        ...
        time_sheets_by_date_model_m = cubista.PullByRelatedField(
            foreign_table=lambda: QuarterTimeSheetByDateModel,
            related_field_names=["quarter_id"],
...
class QuarterTimeSheetByDateModel(time_sheet_by_date_model.ModelTable):
    class Model:
        source = lambda: QuarterTimeSheetByDate
        entity_id_field_name = "quarter_id"

    class Fields:
        quarter_id = time_sheet_by_date_model.EntityIdField(source="quarter_id")
