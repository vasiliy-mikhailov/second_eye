...
class ProjectTeamQuarterTimeSheetByDate(cubista.AggregatedTable):
    class Aggregation:
        source = lambda: time_sheet.WorkItemTimeSheet
        sort_by: [str] = ["date"]
        group_by: [str] = ["project_team_quarter_id", "date"]
        filter = None
        filter_fields: [str] = []
    ...
    class Fields:
        ...
        time_spent_cumsum = cubista.CumSumField(source_field="time_spent", group_by=["project_team_quarter_id"], sort_by=["date"])
        ...
        time_spent_with_value_cumsum = cubista.CumSumField(source_field="time_spent_with_value", group_by=["project_team_quarter_id"], sort_by=["date"])
        time_spent_without_value_cumsum = cubista.CumSumField(source_field="time_spent_without_value", group_by=["project_team_quarter_id"], sort_by=["date"])
        ...
        time_spent_for_reengineering_cumsum = cubista.CumSumField(source_field="time_spent_for_reengineering", group_by=["project_team_quarter_id"], sort_by=["date"])
        time_spent_not_for_reengineering_cumsum = cubista.CumSumField(source_field="time_spent_not_for_reengineering", group_by=["project_team_quarter_id"], sort_by=["date"])
        ...
        dedicated_team_quarter_id = cubista.PullByRelatedField(
            ...
            related_field_names=["project_team_quarter_id"],
        ...
        time_sheets_by_date_model_m = cubista.PullByRelatedField(
            foreign_table=lambda: ProjectTeamQuarterTimeSheetByDateModel,
            related_field_names=["project_team_quarter_id"],
...
class ProjectTeamQuarterTimeSheetByDateModel(time_sheet_by_date_model.ModelTable):
    class Model:
        source = lambda: ProjectTeamQuarterTimeSheetByDate
        entity_id_field_name = "project_team_quarter_id"

    class Fields:
        project_team_quarter_id = time_sheet_by_date_model.EntityIdField(source="project_team_quarter_id")
